@REM meikobbsrv launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM MEIKOBBSRV_config.txt found in the MEIKOBBSRV_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%MEIKOBBSRV_HOME%"=="" set "MEIKOBBSRV_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%MEIKOBBSRV_HOME%\lib\"
...
set "CFG_FILE=%MEIKOBBSRV_HOME%\MEIKOBBSRV_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running meikobbsrv.
  echo.
